                ...
                <form id="roleFrom" role="form" method="POST"
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <lebel>Role Name</lebel>
                            <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ $role->name ?? ''  }}" required placeholder="Role Name">
                            @error('name')
